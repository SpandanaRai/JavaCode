...
public class StringUtils {
	...
	public static final String GET_USERNAME = "SELECT COUNT(*) FROM user_table WHERE username = ?";
	public static final String GET_PHONE = "SELECT COUNT(*) FROM user_table WHERE phoneNumber = ?";
	public static final String GET_EMAIL = "SELECT COUNT(*) FROM user_table WHERE email = ?";
	public static final String GET_ALL_USERS = "SELECT * FROM user_table";
	...
	public static final String CHECK_ADMIN = "SELECT USERNAME FROM user_table WHERE USERNAME=? AND isAdmin='true'";
	...
	public static final String INSERT_FEEDBACK = "INSERT INTO about_us (email, number, feedback) VALUES ( ?, ?, ?)";
	public static final String GET_FEEDBACK_INFO = "SELECT * FROM about_us WHERE email = ?";
	...
	public static final String FEEDBACK_SUCCESS_MESSAGE = "Feedback saved.!";
	public static final String FEEDBACK_ERROR_MESSAGE = "Error occurred during database operation!";
	...
	public static final String SAVE_PATH = "C:/Users/ashis/eclipse-workspace/LaptopNexus/src/main/webapp/images/";
	// End Servlet Route
}
